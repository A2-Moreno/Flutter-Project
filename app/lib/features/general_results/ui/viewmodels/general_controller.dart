...
class CourseResultsController extends GetxController {
  ...
  final students = <Map<String, dynamic>>[].obs;
      final group_results = <GroupActivityAverage>[].obs;
  ...
  Future<void> loadCourseResults(String courseId) async {
    try {
      ...
      logInfo("🟢 Resultados crudos: ${results.length}");
      ...
      logInfo("🟢 Resultados listos para UI: ${students.length}");
      print(students);
    } catch (e) {
